  ...
  return (
    <>
      ...
      >
          ...
          <Form>
            <Form.Group as={Row}>
              <Form.Label as='legend' column sm={2}>
                1. How appealing do you find this type of machine appealing?
              </Form.Label>
              <Col sm={10}>
                <Form.Check
                  type='radio'
                ...
                <Form.Check
                  type='radio'
                  label='Not very appealing'
                  name='formHorizontalRadios'
                  id='formHorizontalRadios3'
                />
                <Form.Check
                  type='radio'
                  label='Not appealing at all'
                  name='formHorizontalRadios'
                  id='formHorizontalRadios3'
                />
              </Col>
        ...
        <Row>
          <p>Semiautomatic Espresso Makers:</p>
          <Form>
            <Form.Group as={Row}>
              <Form.Label as='legend' column sm={2}>
                2. How appealing do you find this type of machine?
              </Form.Label>
              <Col sm={10}>
                <Form.Check
                  type='radio'
